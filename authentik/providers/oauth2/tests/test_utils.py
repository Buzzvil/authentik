...
class TestCorsAllow(TestCase):
    ...
    def test_regex_rejects_origin_suffix(self):
        """An allowed hostname followed by an attacker domain must not match."""
        response = cors_allow(
            self._post("https://app-abc.example.com.attacker.invalid"),
            HttpResponse(),
